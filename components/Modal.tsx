                    ...
                    rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                        ...
                        <div className='mt-2'>
                            ...
                            {image && (
                                <Image
                                    ...
                                    width={200}
                                    height={200}
                                    className="w-full h-44 object-cover mt-2 filter hover:grayscale transition-none
                        ...
                        <div>
                            <button
                                ...
                                text-sm font-medium text-blue-900 hover:bg-blue-200 focu:outline-none focus-visible:ring-2
